...
const token = require("kahoot.js-latest/src/util/token.js");
const ws = require("ws");
const sleep = require("kahoot.js-latest/src/util/sleep.js");
const ua = require("random-useragent");
const ChallengeHandler = require("kahoot.js-latest/src/util/ChallengeHandler.js");
...
class Client extends EventEmitter{
  ...
  constructor(options){
    ...
    // apply main modules
    require("kahoot.js-latest/src/modules/main.js").call(this);
